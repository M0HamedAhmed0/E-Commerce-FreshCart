                    ...
                    <div className="row grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 gap-y-12 my-12 m-auto">
                        {products.length == 0
                            ...
                            : searchItem.map((product, index) => (
                                  ...
                                  >
                                      <div className="card max-h-fit w-full relative z-20 overflow-hidden hover:overflow-visible max-w-sm bg-white hover:border transition border-gray-200 rounded-lg duration-500 hover:shadow-shadow-green hover:scale-110">
                                          <div>
                                              <img
